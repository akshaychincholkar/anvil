...
const S = {
  ...
  head: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "16px 18px", borderBottom: "1px solid var(--border)" },
  ...
  body: { padding: "16px 18px 20px", overflowY: "auto" },
